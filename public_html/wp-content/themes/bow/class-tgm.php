...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     				=> 'Themesawesome Gallery', // The plugin name
			'slug'     				=> 'themesawesome-gallery', // The plugin slug (typically the folder name)
			'source'   				=> get_stylesheet_directory() . '/plugins/themesawesome-gallery.zip', // The plugin source
